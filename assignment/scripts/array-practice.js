...
let favoriteFoods = ['steak', 'mashed potatoes', 'greenbeans', 'corn']
...
console.log('Add dessert to end of favorite foods,', favoriteFoods)
...
console.log(`Added entree to beginning of favoriteFoods: ${favoriteFoods}`)
...
console.log('First color is now', colors)
...
gems[1]='Tourmaline' // 'Citrine" is in position [1]. Replace [1] with 'Tourmaline'.


// 5.b (STRETCH) TODO: Sort your gems array in reverse alphabetical order.
//     Please console.log the sorted array.
var sorted_gems = gems.sort();
console.log(gems)
var sorted_gems = gems.reverse();
console.log(gems)
